...
<head>
    ...
    <style>
        ...
        .video-card {{ background: #16213e; border-radius: 10px; overflow: hidden; transition: transform 0.2s; }}
        .video-card:hover {{ transform: translateY(-3px); }}
        .video-thumb {{ width: 100%; aspect-ratio: 16/9; background: linear-gradient(135deg, #0f3460 0%, #1a1a2e 100%); display: flex; align-items: center; justify-content: center; font-size: 2em; }}
        ...
        .badge {{ background: #1a5f7a; padding: 2px 8px; border-radius: 10px; font-size: 0.8em; }}
    </style>
</head>
<body>
    <div class="header">
        ...
        <div class="video-info">
            ...
            <div class="video-summary">
                ...
                <div class="video-detail">
                    ...
                    <p><strong>URL:</strong> <a href="{v["url"]}" target="_blank" style="color: #5b9bd5;">YouTube</a></p>
                </div>
            </div>
        </div>
    </div>
